...
class VoxelResBackBone8x(nn.Module):
    def __init__(self, output_shape,
        ...
        self.recon = spconv.SparseSequential(
            block(128, 128, 3, norm_fn=norm_fn, padding=1, indice_key='recon'),
            nn.ReLU(),
        )

        self.logit = spconv.SparseSequential(
            block(256, self.nclasses, 3, norm_fn=norm_fn, padding=1, indice_key='logit')
        )
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        x_recon = self.recon(x_conv4)
        x_recon.features = torch.cat([x_recon.features, x_conv4.features], dim=1)
